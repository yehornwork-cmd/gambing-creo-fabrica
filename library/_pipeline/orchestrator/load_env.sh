...
for secret_var in HF_KEY HF_API_KEY_ID HF_API_KEY_SECRET PERPLEXITY_API_KEY FAL_KEY SPYTREND_CLIENT_ID SPYTREND_CLIENT_SECRET SPYTREND_API_KEY CAPTURE_API_TOKEN CURSOR_API_KEY; do
