# UGC run 20260813T042808Z_ugc_locale_ru

- **preset:** ugc_locale_ru
- **game:** vs20olympgate
- **dry_run:** True
...
Under 120 words. Plainspoken ru voice if locale is not `en`. Entertainment-only disclaimer implied in tone.
